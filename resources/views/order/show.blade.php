<x-app-layout>
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white rounded-lg shadow-lg px-6 py-4 mb-3 grid grid-cols-2">
            ...
            <div class="md:col-span-1 col-span-2">
                <div class="text-gray-700">
                    <p class="text-lg font-semibold uppercase text-right">Hauscenter</p>
        ...
        <div class="grid grid-cols-2 gap-3">
            <div class="md:col-span-1 col-span-2">
                <div class="bg-white rounded-lg shadow-lg px-6 py-4 mb-3">
                    <span class="font-bold text-xs uppercase tracking-widest">Datos del cliente</span>
                    <hr>
            ...
            <div class="md:col-span-1 col-span-2">
                <div class="bg-white rounded-lg shadow-lg px-6 py-4 mb-3">
                    <span class="font-bold text-xs uppercase tracking-widest">Datos de envio</span>
                    <hr>
        ...
        <div class="bg-white shadow-lg rounded-lg px-12 py-8 mb-3 flex justify-between items-center">
            ...
            <div class="{{ ($order->status>=1 && $order->status!=5) ? 'bg-lime-500':'bg-gray-400' }} h-1 flex flex-1 mx-2"></div>
            ...
            <div class="{{ ($order->status>=3 && $order->status!=5) ? 'bg-lime-500':'bg-gray-400' }} h-1 flex flex-1 mx-2"></div>
            ...
            <div class="{{ ($order->status>=4 && $order->status!=5) ? 'bg-lime-500':'bg-gray-400' }} h-1 flex flex-1 mx-2"></div>
